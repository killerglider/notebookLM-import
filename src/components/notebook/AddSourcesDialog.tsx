        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader className="pb-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <DialogTitle className="text-xl font-medium">FridayLM</DialogTitle>
              </div>
            </div>
          </DialogHeader>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600 text-sm mb-1">Sources let FridayLM base its responses on the information that matters most to you.</p>
